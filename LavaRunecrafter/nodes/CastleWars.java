...
public class CastleWars implements Node {

	@Override
	public boolean validate() {
		return !Inventory.isFull() && Inventory.find("Pure essence").length == 0 && Objects.find(10, 4483).length == 0;
	}
	...
	public void execute() {
		...
		if (ringSlot.length > 0) {
			...
			if (ringOfDueling.hover()) {
				if (ringOfDueling.click("Castle Wars")) {
	...
	public String display() {
		return "Teleport to Castle Wars";
	}
